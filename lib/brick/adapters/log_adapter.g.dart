...
Future<Log> _$LogFromSupabase(Map<String, dynamic> data,
  ...
  return Log(
      ...
      squats: data['squats'] as double,
      pullUps: data['pull_ups'] as double,
...
class LogAdapter extends OfflineFirstWithSupabaseAdapter<Log> {
  ...
  final fieldsToSupabaseColumns = {
    ...
    'squats': const RuntimeSupabaseColumnDefinition(
      association: false,
      columnName: 'squats',
    ),
    'pullUps': const RuntimeSupabaseColumnDefinition(
      association: false,
      columnName: 'pull_ups',
    ),
  ...
  final Map<String, RuntimeSqliteColumnDefinition> fieldsToSqliteColumns = {
    ...
    'squats': const RuntimeSqliteColumnDefinition(
      association: false,
      columnName: 'squats',
      iterable: false,
      type: double,
    ),
    'pullUps': const RuntimeSqliteColumnDefinition(
      association: false,
      columnName: 'pull_ups',
      iterable: false,
      type: double,
